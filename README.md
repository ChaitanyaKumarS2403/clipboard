...
* [YT-DLP Video Quality Update](#yt-dlp-toolkit-video-quality-update)

## YT DLP Toolkit Video Quality Update
    ...
    while True:
        ...
        while True:
            ...
            if choice == '1':
                ...
                print(f"\n{WHITE}SELECT QUALITY: {RESET}")
                print(f"{WHITE}{RED}  [1]{WHITE} Best Available{RESET}")
                print(f"{WHITE}{RED}  [2]{WHITE} 1080p (or lower if unavailable){RESET}")
                print(f"{WHITE}{RED}  [3]{WHITE} 720p (or lower if unavailable){RESET}")
                print(f"{WHITE}{RED}  [4]{WHITE} 480p (or lower if unavailable){RESET}")
                
                q_choice = input(f"{WHITE}Quality > {RESET}").strip()
                
                # Default to best quality selection string
                f_selector = "bv*+ba/b" 
                
                if q_choice == '2':
                    f_selector = "bv*[height<=1080]+ba/b[height<=1080]" #
                elif q_choice == '3':
                    f_selector = "bv*[height<=720]+ba/b[height<=720]" #
                elif q_choice == '4':
                    f_selector = "bv*[height<=480]+ba/b[height<=480]" #
